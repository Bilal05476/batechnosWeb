        ...
        <div className="row">
          ...
          <form className="font-weight-bold" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input type="number" className="form-control" id="contact" required 
            ...
            <button type="send" className="btn-block btn__db"
            style={{ background: loader ? "#ccc" : "rgb(214, 43, 100)" }}>Send</button>
          </form>
          <br />
          </div>
        </div>
